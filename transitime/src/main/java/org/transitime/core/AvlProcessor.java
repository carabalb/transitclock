...
public class AvlProcessor {
  ...
  private double getMaxMatchDistanceFromAVLRecord() {
	 ...
	 * unpredictable. Updates VehicleDataCacheImpl. Creates and logs a VehicleEvent
	...
	public void makeVehicleUnpredictable(String vehicleId,
		...
		// Update VehicleDataCacheImpl with the new state for the vehicle
		VehicleDataCacheImpl.getInstance().updateVehicle(vehicleState);
	}
	 ...
	 * been grabbed. Updates VehicleDataCacheImpl. Creates and logs a VehicleEvent
	 * explaining the situation.
	 * 
	 * @param vehicleState
	 *            The vehicle to be made unpredictable
	...
	private void updateVehicleStateFromAssignment(TemporalMatch bestMatch,
		...
		// the VehicleDataCacheImpl is updated with info from the current
  ...
  /**
	...
	private boolean matchProblematicDueOtherVehicleHavingAssignment(
		...
		// not a problem
		Collection<String> vehiclesAssignedToBlock = VehicleDataCacheImpl
	...
	private void lowLevelProcessAvlReport(AvlReport avlReport,
		...
		synchronized (vehicleState) {
			...
			// VehicleDataCacheImpl so that when data queried for API the proper
			// info is provided.
			VehicleDataCacheImpl.getInstance().updateVehicle(vehicleState);
	...
	public void processAvlReport(AvlReport avlReport) {
		...
		VehicleDataCacheImpl.getInstance().cacheVehicleConfig(avlReport);
